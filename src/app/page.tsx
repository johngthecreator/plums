  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-[#6E43B1] to-white">
        <header className="flex flex-row justify-between p-4">
          ...
          <Link href={"/home"} className="p-3 text-white font-bold bg-[#B281F6] rounded-[10px]">Get Learning</Link>
        </header>
        <div className="flex flex-col h-full p-7 gap-8 md:p-14">
          ...
          <Link href={"/home"} className="p-3 text-center self-center md:self-start md:w-1/3 w-5/6 text-white font-bold bg-[#B281F6] rounded-[10px]">Get Learning</Link>
        </div>  
    </div>
  );
}
